const REGIONAL_DB={
  ...
  sources:{
    ...
    energy:{label:'ANEEL — Tarifas Homologadas de Distribuidoras',url:'https://dadosabertos.aneel.gov.br/dataset/tarifas-distribuidoras-energia-eletrica',reference:'tarifa B1 residencial convencional da Celesc vigente desde 22/08/2026 — dados gerados pela ANEEL em 25/08/2026'},
