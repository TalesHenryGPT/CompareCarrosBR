const REGIONAL_DB={
  ...
  sources:{
    fuel:{label:'ANP — Levantamento de Preços de Combustíveis',url:'https://www.gov.br/anp/pt-br/assuntos/precos-e-defesa-da-concorrencia/precos/levantamento-de-precos-de-combustiveis-ultimas-semanas-pesquisadas',reference:'16/08/2026 a 22/08/2026 — planilha publicada em 21/08/2026'},
    energy:{label:'ANEEL — Tarifas Homologadas de Distribuidoras',url:'https://dadosabertos.aneel.gov.br/dataset/tarifas-distribuidoras-energia-eletrica',reference:'tarifas B1 residenciais convencionais — dados gerados pela ANEEL em 28/08/2026; vigências recentes: Sulgipe em 26/08, Neoenergia Elektro em 27/08 e Equatorial Maranhão em 28/08/2026'},
  ...
  fuel:{
    AC:{gas:7.27,eth:5.00},AL:{gas:6.71,eth:5.01},AP:{gas:6.54,eth:5.83},AM:{gas:7.30,eth:4.89},BA:{gas:6.73,eth:4.48},CE:{gas:6.95,eth:4.97},DF:{gas:6.62,eth:4.30},ES:{gas:6.49,eth:4.64},GO:{gas:6.61,eth:4.16},MA:{gas:6.68,eth:5.03},MT:{gas:6.71,eth:3.69},MS:{gas:6.41,eth:3.86},MG:{gas:6.18,eth:3.90},PA:{gas:6.64,eth:4.73},PB:{gas:6.45,eth:4.70},PR:{gas:6.64,eth:4.10},PE:{gas:6.84,eth:5.02},PI:{gas:6.82,eth:4.84},RJ:{gas:6.62,eth:4.69},RN:{gas:6.63,eth:5.07},RS:{gas:6.23,eth:4.43},RO:{gas:7.36,eth:5.22},RR:{gas:7.56,eth:5.40},SC:{gas:6.50,eth:4.36},SP:{gas:6.34,eth:3.61},SE:{gas:7.02,eth:5.33},TO:{gas:7.03,eth:4.96}
  },
  ...
  currentFlag:'yellow',
  distributors:{
    AC:[['EAC',.87381]],AL:[['Equatorial Alagoas',.85141]],AP:[['CEA Equatorial',.82515]],AM:[['Âmbar Amazonas',.87571]],BA:[['Neoenergia Coelba',.87773]],CE:[['Enel Ceará',.74977]],DF:[['Neoenergia Brasília',.82672]],ES:[['EDP Espírito Santo',.84371],['ELFSM',.74537]],GO:[['Equatorial Goiás',.89181],['CHESP',.81975]],MA:[['Equatorial Maranhão',.88884]],MT:[['Energisa Mato Grosso',.89942]],MS:[['Energisa Mato Grosso do Sul',.98660]],MG:[['Cemig-D',.90329],['DMED',.61757],['Energisa Minas Rio',.91899]],PA:[['Equatorial Pará',.97830,'última tarifa disponível; vigência encerrada em 06/08/2026']],PB:[['Energisa Paraíba',.67565]],PR:[['Copel-DIS',.76802]],PE:[['Neoenergia Pernambuco',.79886]],PI:[['Equatorial Piauí',.94669]],RJ:[['Light',.88056],['Enel Rio',1.06110]],RN:[['Neoenergia Cosern',.77580]],RS:[['CEEE Equatorial',.82200],['RGE',.94461]],RO:[['Energisa Rondônia',.84139]],RR:[['Âmbar Energia Roraima',.78947]],SC:[['Celesc',.75975]],SP:[['Enel São Paulo',.78938],['CPFL Paulista',.73945],['CPFL Piratininga',.73969],['Neoenergia Elektro',.89163],['EDP São Paulo',.78670],['CPFL Santa Cruz',.81258]],SE:[['Energisa Sergipe',.75461],['Sulgipe',.81424]],TO:[['Energisa Tocantins',1.00606]]
  },
