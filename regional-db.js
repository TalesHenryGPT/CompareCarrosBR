const REGIONAL_DB={
  ...
  sources:{
    fuel:{label:'ANP — Levantamento de Preços de Combustíveis',url:'https://www.gov.br/anp/pt-br/assuntos/precos-e-defesa-da-concorrencia/precos/levantamento-de-precos-de-combustiveis-ultimas-semanas-pesquisadas',reference:'06/09/2026 a 12/09/2026 — planilha publicada em 14/09/2026'},
    energy:{label:'ANEEL — Tarifas Homologadas de Distribuidoras',url:'https://dadosabertos.aneel.gov.br/dataset/tarifas-distribuidoras-energia-eletrica',reference:'tarifas B1 residenciais convencionais — dados gerados pela ANEEL em 18/09/2026; republicações vigentes desde 26/08/2026 para Energisa Acre, Enel Ceará, Energisa Rondônia, Sulgipe e Energisa Tocantins'},
  ...
  fuel:{
    AC:{gas:7.47,eth:4.96},AL:{gas:6.63,eth:4.96},AP:{gas:6.70,eth:5.81,ethReference:'30/08/2026 a 05/09/2026 — última média estadual disponível na ANP; sem média de etanol publicada para 06 a 12/09/2026'},AM:{gas:7.32,eth:5.28},BA:{gas:6.70,eth:4.52},CE:{gas:6.98,eth:5.00},DF:{gas:6.68,eth:4.38},ES:{gas:6.44,eth:4.59},GO:{gas:6.67,eth:4.36},MA:{gas:6.58,eth:5.03},MT:{gas:6.68,eth:3.82},MS:{gas:6.40,eth:3.89},MG:{gas:6.31,eth:4.12},PA:{gas:6.67,eth:4.64},PB:{gas:6.43,eth:4.63},PR:{gas:6.60,eth:4.08},PE:{gas:6.75,eth:4.89},PI:{gas:6.79,eth:4.80},RJ:{gas:6.63,eth:4.74},RN:{gas:6.90,eth:5.39},RS:{gas:6.17,eth:4.42},RO:{gas:7.40,eth:5.12},RR:{gas:7.56,eth:5.39},SC:{gas:6.40,eth:4.31},SP:{gas:6.35,eth:3.76},SE:{gas:7.02,eth:5.34},TO:{gas:6.94,eth:4.97}
  },
  ...
  currentFlag:'yellow',
  distributors:{
    AC:[['EAC',.82971]],AL:[['Equatorial Alagoas',.85141]],AP:[['CEA Equatorial',.82515]],AM:[['Âmbar Amazonas',.87571]],BA:[['Neoenergia Coelba',.87773]],CE:[['Enel Ceará',.70175]],DF:[['Neoenergia Brasília',.82672]],ES:[['EDP Espírito Santo',.84371],['ELFSM',.74537]],GO:[['Equatorial Goiás',.89181],['CHESP',.81975]],MA:[['Equatorial Maranhão',.88884]],MT:[['Energisa Mato Grosso',.89942]],MS:[['Energisa Mato Grosso do Sul',.98660]],MG:[['Cemig-D',.90329],['DMED',.61757],['Energisa Minas Rio',.91899]],PA:[['Equatorial Pará',.97830]],PB:[['Energisa Paraíba',.70970]],PR:[['Copel-DIS',.76802]],PE:[['Neoenergia Pernambuco',.79886]],PI:[['Equatorial Piauí',.94669]],RJ:[['Light',.88056],['Enel Rio',1.06110]],RN:[['Neoenergia Cosern',.77580]],RS:[['CEEE Equatorial',.82200],['RGE',.94461]],RO:[['Energisa Rondônia',.76244]],RR:[['Âmbar Energia Roraima',.78947]],SC:[['Celesc',.75975]],SP:[['Enel São Paulo',.78938],['CPFL Paulista',.73945],['CPFL Piratininga',.73969],['Neoenergia Elektro',.89163],['EDP São Paulo',.78670],['CPFL Santa Cruz',.81258]],SE:[['Energisa Sergipe',.75461],['Sulgipe',.71881]],TO:[['Energisa Tocantins',.99278]]
  },
